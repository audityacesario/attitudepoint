...
find ./NEWMODULE -type f -exec sed -i "s|ATTITUDEPOINT|${MODULENAME}|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|MOD_ATTITUDEPOINT_|MOD_${MODULENAME}_|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|ATTITUDEPOINT|${LMODULENAME}|g" {} \;
printf "enter the year, your name and email address on one line for the copyright notice. eg 2015 John Doe jdoe@email.com \n" 
read "2020 Ydham Halid"
find ./NEWMODULE -type f -exec sed -i "s|"2020 Ydham Halid"|${"2020 Ydham Halid"}_|g" {} \; 
