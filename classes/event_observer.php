...
/**
 * Event observer for attitudepoint plugin
 *
 * @package    mod_attitudepoint
 * @copyright  "2020 Ydham Halid"
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 namespace mod_attitudepoint;
...
/**
 * Event observer for mod_attitudepoint
 *
 * @package    mod_attitudepoint
 * @copyright  "2020 Ydham Halid"
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class event_observer{
    ...
    public static function course_deleted(\core\event\course_deleted $event) {
       global $DB;
		//MOD_ATTITUDEPOINT_TABLE should be deleted elsewhere
		...
		$ret = $DB->delete_records(MOD_ATTITUDEPOINT_USERTABLE,array('courseid'=>$event->objectid));
		return $ret;
	}
}
